...
export default function UpdatePasswordPage() {
    ...
    useEffect(() => {
        // Check if we have a session (handled by Supabase automatically from the link)
        const checkSession = async () => {
            ...
            if (!session) {
                ...
                setMessage({
                    type: 'error',
                    text: 'Sessão inválida ou expirada. Por favor, solicite um novo link.'
                });
            }
        };
        checkSession();
                ...
                <div className="bg-neutral-900/50 backdrop-blur-xl border border-neutral-800 rounded-2xl p-8 shadow-2xl">
                    ...
                    <form onSubmit={handleUpdate} className="space-y-4">
                        <div className="space-y-1">
                            <label className="text-xs font-medium text-neutral-400 ml-1">Nova Senha</label>
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    required
                                />
                                <CheckCircle className="w-4 h-4 text-neutral-500 absolute left-3 top-3.5" />
                            </div>
                        </div>
